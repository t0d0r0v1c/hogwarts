...
<!-- Ovde ubacujes fju koja zove root putanju od wp-a tipa wp-content/theme/curent-theme/... --->
    ...
    <div class="full-width-split group">
      <div class="full-width-split__one">
        <div class="full-width-split__inner">
          ...
          <p class="t-center no-margin"><a href="<?php echo get_post_type_archive_link('quidditch'); ?>" class="btn btn--blue">View All Events</a></p>
        </div>
      </div>
